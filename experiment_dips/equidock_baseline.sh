...
#SBATCH --job-name=Equidock_baseline_dips       #Set the job name to "JobExample4"
#SBATCH --time=48:00:00              #Set the wall clock limit to 1hr and 30min
#SBATCH --ntasks=1                   #Request 1 task
#SBATCH --mem=204800M                  #Request 2560MB (2.5GB) per node
#SBATCH --output=Equidock_baseline_dips.%1      #Send stdout/err to "Example4Out.[jobID]"
...
cd ..
CUDA_VISIBLE_DEVICES=0 python -m src.train -dropout 0 -drop_message None -drop_message_rate 0 -drop_connect None -drop_connect_rate 0 -iegmn_n_lays 8 -patience 100